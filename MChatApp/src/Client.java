                ...
                while(connection){
                    ...
                    try {
                        ...
                        if (messageFromClient.startsWith("#")){
                            ...
                            if(usernum<Integer.parseInt(messageFromClient)){
                                for(int i=usernum; i<Integer.parseInt(messageFromClient);i++){
                                    ChatControl.displayUsername(""+(i+1));
                                    usernum += 1;
                                }
                            }
                            //ChatControl.displayUsername(messageFromClient);
                        }else{
